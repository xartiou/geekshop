...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # создание действия акции-скидки если есть условие
        ...
        #  пересчет цены в акции-скидки (если условие - тогда цена)
        ...
        # "annotate" даёт возможность добавить свои условия к запросу
        ...
        #  создаем таблицу, что бы увидеть её в отладке
